...
let viewModel2 = "2021-10-22T20:23:00.000Z"
let dateFormatter = DateFormatter()
dateFormatter.dateFormat = "dd.MM.yyyy HH:mm:ss"
dateFormatter.timeZone = TimeZone(abbreviation: "GMT+00:00")
let newDate = dateFormatter.date(from: viewModel2)
print("\(newDate as Date?)")
//func getFormattedDate(date: String, format: String) {
//
//    let dateFormatter = DateFormatter()
//    dateFormatter.dateFormat = format
//    var newDate: Date = Date.distantPast
//    var result = ""
//    var array: [String] = []
//    for element in date {
//        newDate = dateFormatter.date(from: String(element))!
